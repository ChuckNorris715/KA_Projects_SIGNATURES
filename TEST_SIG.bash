                                ...
                                <tr>
                                    ...
                                    <td valign="middle" align="center" style="padding-left:15px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td valign="top" align="left" class="qe_defaultlink" style="font-family: 'Montserrat', Arial, sans-serif;font-size:16px;line-height:20px;color:#231f20; font-weight:bold;">$i</td>
                                            </tr>
                                            ...
                                            <!-- Please delete from the <tr> to the </tr> above if you do not have credentials -->
                                            <tr>
                                                <td valign="top" align="left" class="qe_defaultlink" style="font-family: 'Montserrat', Arial, sans-serif;font-size:10px;line-height:13px;color:#000000; padding-top:5px;">Systems Administrator</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td valign="top" align="left" class="qe_defaultlink" style="font-family: 'Montserrat', Arial, sans-serif;font-size:9px;line-height:13px;color:#000000;"><a href="mailto:csiket@thriven.design" style="text-decoration:none;color:#000000;">csiket@thriven.design</a></td>
                                            </tr>
                                            <tr>
                                                <td valign="top" align="left" class="qe_defaultlink" style="font-family: 'Montserrat', Arial, sans-serif;font-size:9px;line-height:13px;color:#000000;padding-top:5px; "><strong>t: </strong><a style="text-decoration:none;color:#000000;">856.854.1880 x352</a>&nbsp;|&nbsp;<strong>d: </strong><a style="text-decoration:none;color:#000000;">856.607.2452</a></td>
                                            </tr>
                                            <tr>
...
for i in $NAME
do
echo $fn_htmlBlock >> /Volumes/Samsung_T5\ 1/KA_Projects/_SIGNATURES/${userName}_sig.html
done;